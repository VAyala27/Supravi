 <?php
    ...
    if (isset($_POST['upload'])) {
        ...
        if (array_filter($errors)) {
            ...
            $sql = "INSERT INTO products(product_img,product_name,product_price,category_id) VALUES('$product_img','$product_name','$product_price','$category_id')";
     ...
     <main>
         <div class="row justify-content-center align-items-center height-100">
             <div class="col-md-6 offset-md-3 px-0">
                 <h1 class="text-center mt-5">Upload Items</h1>
                 <form action="" method="POST" enctype="multipart/form-data">
                     <div class="form-group mx-auto">
                         ...
                         <div class="text-danger"><?php echo $errors['product_img']; ?></div>
                         ...
                         <br>
                         <input type="submit" value="Upload" class="btn btn-dark mx-auto w-25 d-block mb-5"
                             name="upload">
                     </div>
                 </form>
             </div>
