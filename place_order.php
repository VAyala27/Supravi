...
<body>
    ...
    <main class="height-100">
        <h1 class="display-4 p-4">Thank You!</h1>
        <div class="success order-confirm p-3">
            <p><strong>Your Order has been placed!</strong> Thank you very much</p>
            <a class="text-dark" href="index.php">Go Back</a>
        </div>
    </main>
